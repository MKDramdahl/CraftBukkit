...
public class BlockAgricultureTest {

	public BlockAgriculture blockAgriculture = new BlockAgriculture();

	@Test
	public void testTrueTrueTrueTrue() {
		testWorld tester = new testWorld(true, true, true, true);
		assertEquals(blockAgriculture.n(tester, 1, 1, 1), 4.0F, 0.5);
	}
	...
	public void testTrueFalseTrueTrue() {
		...
		assertEquals(blockAgriculture.n(tester, 1, 1, 1), 10.0F, 0.5);
	}
